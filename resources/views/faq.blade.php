    ...
    <div class="accordion" id="faqAccordion">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="faqHeadingThree">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapseThree" aria-expanded="false" aria-controls="faqCollapseThree">
            What databases are supported for backup?
          </button>
        </h2>
      ...
      <div class="accordion-item">
        ...
        <div id="faqCollapseFive" class="accordion-collapse collapse" aria-labelledby="faqHeadingFive" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Installation is quick and simple: prepare your MySQL database, download our installer, and follow the step-by-step setup wizard. Within minutes, you’re ready to go.
            <br><br>
            <a href="#cta" class="btn btn-sm btn-outline-primary mt-3">Get Started</a>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faqCollapseSix" class="accordion-collapse collapse" aria-labelledby="faqHeadingSix" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Yes. Every official purchase includes one year of dedicated support. We also offer extended support packages on request.
            <br><br>
            <a href="#cta" class="btn btn-sm btn-outline-primary mt-3">Contact Us for Support</a>
          </div>
        </div>
      </div>
