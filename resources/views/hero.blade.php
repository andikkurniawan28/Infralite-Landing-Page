            ...
            <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-10">
                <div class="hero-content">
                    <h1 class="text-dark mb-3">
                        Fix IT Issues. <span class="text-primary">Fast.</span> Without the Fuss.
                    </h1>
                    ...
                    <a href="#feature-1" class="btn btn-outline-dark btn-lg">Explore Features</a>
                    <a href="#pricing" class="btn btn-outline-dark btn-lg">See Pricing</a>
                    <p class="text-muted mt-3 small">⚡ No credit card required · Cancel anytime</p>
                </div>
            </div>
